...
{
    /// <summary>
    /// the user interface of the game scene.
    /// </summary>
    public class MainHud : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            EventBus<OnPlayerIncomeModified>.OnEvent += UpdateMoneyNumber;
        ...
        private void UpdateMoneyNumber(OnPlayerIncomeModified onPlayerIncomeModified)
        {
            moneyNumberText.text = onPlayerIncomeModified.NewMoney.ToString();
        }
